import heapq
from set_get_functions import get_neighbors,display_maze , set_cost 

# calculating the F(n) of the algorithm         
def calculate_cost(neighbor,g_cost):
        return g_cost[neighbor] 
...
def uniform_cost_search(maze,start,goal):
        ...
        heapq.heappush(queue,(calculate_cost(start,g_cost),start))
        ...
        # adding current node to a visited list 
            ...
            for neighbor in get_neighbors(current,maze):
                ...
                if neighbor not in g_cost or tentative_g < g_cost[neighbor]:
                    ...
                    f = calculate_cost(neighbor, g_cost)
